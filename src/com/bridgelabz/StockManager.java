...
public class StockManager implements StockAccountInterface {
	...
	public double valueOf() {                                                             // method to print the account balance
		...
		System.out.println(" The current balance in account is: " + StockAccount.getAmount()); // using getters to get balance
		return StockAccount.getAmount();
	}

	public StockPortfolio findStock(String name) {                                         // function to get find stock as per the user input
	...
	public void buy(int amount, String symbol) {                                         //method to buy stock with parameter amount and stock name as symbol

		if (amount > StockAccount.getAmount()) {                                              //if stock amount greater than account balance then alert user
		...
		StockAccount.debit(debit_value);
	...
	public void sell(int amount, String symbol) {                                    //method to sell stock
		...
		StockAccount.credit(credit_value);                                                    // crediting the account with the stock sold amount
